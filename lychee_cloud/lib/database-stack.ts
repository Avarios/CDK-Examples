...
import { Vpc, SecurityGroup, Instance, InstanceType, InstanceClass, InstanceSize } 
...
export class Database extends Construct {
  constructor(parent: Stack, name: string, props: DatabaseProps) {
    ...
    const databaseUsername = 'lycheeRoot';
    ...
    // Database
    const rdsInstance = new DatabaseInstance(this, 'lychee-database', {
      ...
      instanceIdentifier: "lychee-database"
    });
